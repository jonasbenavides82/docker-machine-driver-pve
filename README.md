...
1. In `local` cluster explorer (i.e. the cluster where Rancher is deployed) go to `Apps > Repositories > Create` and create repository with following settings:
    ...
    * Index URL: `https://jonasbenavides82.github.io/docker-machine-driver-pve`
    * Authentication: `None`
...
1. Download all required files on your jump machine:
    ...
    1. Set a variable with version to download (see [releases](https://github.com/jonasbenavides82/docker-machine-driver-pve/releases) for available versions):
    ...
    1. Add Helm repository:
        ...
        ```sh
        helm repo add pve-node-driver https://jonasbenavides82.github.io/docker-machine-driver-pve
        ```
